...
IQAI_API_KEY=339be55a-567e-4622-9dbc-83cf826951c9 

# === LLM PRIORITY CHAIN ===
# Primary model (fallback handled via code)
LLM_MODEL=gpt-4o-mini

# Optional secondary (used only if primary fails)
LLM_MODEL_FALLBACK=gemini-2.5-flash

# Server Port
PORT=8042

# Webhook Verify Token (para Instagram)
WEBHOOK_VERIFY_TOKEN=flowcloser_webhook_neo

# === LLM PRIORITY CHAIN ===
OPENAI_API_KEY=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

# Google API Key (for Gemini models)
GOOGLE_API_KEY=AIzaSyBvJNLAy2B6HB5-xL3T5MCahIvJH2p71Uc
